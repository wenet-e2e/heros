...
- Latest verification report/event status can be inspected without rerunning network verification.
...
- Runtime state/status exposes announcement summary for the single realtime audio outlet.
